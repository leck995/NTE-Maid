...
public class PlayerIdChangeEvent implements Consumer<String> {
    ...
    private static final Logger log = LoggerFactory.getLogger(PlayerIdChangeEvent.class);
    private final BankKeyEvent event;

    public PlayerIdChangeEvent() {
